...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  loca=(Button) findViewById(R.id.bt_send_loc);
        loca.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(MapsActivity.this,UserFormActivity.class);
    ...
    /*A dialog box is presented whenever any App requests permissions.
    When the user responds, the system invokes app’s onRequestPermissionsResult() method,
    passing it the user response.
    Our app has to override this method to find out whether the permission was granted.*/
...
////////////////////////////////
   ...
   /* @Override
    ...
    public void valueIntentLocation(){
        Intent intent=new Intent(MapsActivity.this,UFormActivity.class);
