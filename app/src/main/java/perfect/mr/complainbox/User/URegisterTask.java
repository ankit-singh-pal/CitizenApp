...
public class URegisterTask extends AsyncTask<String,Void,String> {
    Context ctx;

    @Override
    protected String doInBackground(String... params) {
        String reg_url="https://unturbid-contrast.000webhostapp.com/insert_user_data.php";
        ...
        if(m.equals("Registration")){
            ...
            String user_pincode=params[7];
            String user_contact_no=params[8];
            String user_email_id=params[9];
            String user_password=params[10];
            ...
            try {
                ...
                String data=URLEncoder.encode("user_id", "UTF-8")+"="+URLEncoder.encode(user_id,"UTF-8")+"&"+
                        ...
                        URLEncoder.encode("user_email_id","UTF-8")+"="+URLEncoder.encode(user_email_id,"UTF-8")+"&"+
    ...
    public URegisterTask(Context ctx) {
        this.ctx=ctx;
    }
    @Override
